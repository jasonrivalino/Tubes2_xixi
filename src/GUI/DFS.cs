...
namespace dfsSearching
{
    ...
    public class Algorithm
    {
        ...
        public static int adjacentPoints(char[,] arr, Stack<Points> visited, Stack<Points> unvisited, Stack<Points> backtracking, int countBacktracking, Stack<int> countNode)
        {
